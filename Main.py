def main():
    print('hello world. I once met a traveler from an antique land who said: two vast and trunkless legs'
          'of stone stand in the desert. Near them, in the sand,  Half sunk a shattered visage remains, whos frown, and'
          'wrinkled lip, and sneer of cold command, tell that its sculptor well those passions read, which yet survive'
